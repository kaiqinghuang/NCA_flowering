...
**orthogonally** to the TV plane — i.e. dropped along the plane
normal. For a horizontal TV laid flat on the floor the plane normal
is the true vertical (gravity) direction, so this is where the
fingertip maps on the canvas.
